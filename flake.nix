  ...
  outputs = { self, nixpkgs, home-manager, ... }@inputs:
    let
      ...
      getUsers = let
        ...
        filterDirectories = dir: 
          let contents = readDir dir;
          in builtins.filter (name: isDirectory contents.${name}) (builtins.attrNames contents);
      in
        if builtins.pathExists /home
        then filterDirectories /home
        else [ defaultUser ];
    in
    {
